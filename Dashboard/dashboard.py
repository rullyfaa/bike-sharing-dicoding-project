...
day_data = pd.read_csv(
    "https://raw.githubusercontent.com/rullyfaa/bike-sharing-dicoding-project/main/Dashboard/day_df.csv")
hour_data = pd.read_csv(
    "https://raw.githubusercontent.com/rullyfaa/bike-sharing-dicoding-project/main/Dashboard/hour_df.csv")
